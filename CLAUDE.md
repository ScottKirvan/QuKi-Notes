...
| | 3.49 Block indentation Stage 1 — multi-run rendering foundation + nested blockquotes (ADR-34, #242, #237) | Complete (PR #292, merged 2026-07-23) — device test pending |
