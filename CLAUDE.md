...
| | 3.55 Text selection Stage 3 — auto-scroll while dragging a handle (ADR-36) | Complete (PR #325, merged 2026-08-03) — device-tested and accepted on the first attempt, no fix rounds needed. Keeps the dragged selection boundary resolving correctly against a stationary finger while content scrolls continuously underneath it, reusing Stage 2 Round 1's post-frame-deferred scroll-notification machinery. Stage 4 (magnifier + haptics, explicitly provisional) not yet briefed |
...
## Implementation Notes (current as of v0.18.2 + PRs #257–#260, #270, #276, #279, #281, #283, #290, #292, #294, #295, #307–#311, #314, #320, #323, #325 merged; release-please pending)
