...
**Not yet device-tested**: Round 7's fix and new telemetry. This is the current state — awaiting the next device test against the same two-app-with-both-keyboards-open repro Rounds 5-6's evidence came from.
