...
**PRs open**: none as of this sync (2026-08-01) — check `gh pr list` fresh, as always, rather than trusting this being kept current in real time.

**Merged since last sync (2026-08-01) — HTML paste + text selection Stage 1**:
